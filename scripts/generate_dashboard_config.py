...
def main():
    ...
    courses_data = {
        ...
        "important_dates": {
            ...
            "drop_deadline": fall_2025.get('critical_deadlines', {}).get('add_drop', {}).get('date', '2025-09-05'),
            "withdrawal_deadline": fall_2025.get('critical_deadlines', {}).get('withdrawal_deadline', {}).get('date', '2025-10-31')
        },
        "courses": []
    }
        ...
        course = {
            ...
            "blackboard": {
                ...
                "links": {
                    ...
                    "grade_center": f"https://blackboard.alaska.edu/webapps/gradebook2/controller"
                }
            }
        }
    ...
    print(f"✓ Generated dashboard/state/courses.json")
    ...
    if not tasks_path.exists():
        ...
        print(f"✓ Created initial dashboard/state/tasks.json")
