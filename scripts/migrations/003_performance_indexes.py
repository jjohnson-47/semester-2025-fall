...
def benchmark_queries(conn: sqlite3.Connection):
    ...
    test_queries = [
        ...
        ("Due date range", "SELECT COUNT(*) FROM tasks WHERE due_at BETWEEN '2025-09-01' AND '2025-09-30'"),
        ("Composite query", "SELECT * FROM tasks WHERE course = 'MATH251' AND status = 'pending' ORDER BY due_at LIMIT 10"),
