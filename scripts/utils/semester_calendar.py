...
class SemesterCalendar:
    ...
    def __init__(self, calendar_file: str = "academic-calendar.json"):
        ...
        self.timezone = pytz.timezone("America/Anchorage") if pytz else "America/Anchorage"
    ...
    def get_semester_dates(self) -> dict[str, Any]:
        ...
        return {
            ...
            "withdrawal": self._parse_date(
                semester["critical_deadlines"]["withdrawal_deadline"]["date"]
            ),
        }
