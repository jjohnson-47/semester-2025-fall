...
class SyllabusBuilder:
    ...
    def _generate_pdf(self, html_path: Path, course_code: str) -> Optional[Path]:
        ...
        try:
            ...
            try:
                ...
                print(f"Warning: PDF generation skipped (install weasyprint or pandoc)")
                return None
    
    def build_all(self, courses: Optional[List[str]] = None) -> Dict[str, Dict[str, str]]:
