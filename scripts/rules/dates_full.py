...
class DateRules(_DateRules):  # type: ignore[misc]
  ...
  def apply_rules(self, date: datetime, assignment_type: AssignmentType = AssignmentType.HOMEWORK) -> datetime:
  ...
  def shift_from_weekend(self, date: datetime, direction: ShiftDirection | object = ShiftDirection.EARLIER) -> datetime:  # type: ignore[override]
