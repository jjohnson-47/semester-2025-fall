...
class SyllabusGenerator:
    ...
    def html_to_docx(self, html_content: str, output_file: str) -> bool:
        ...
        try:
            ...
            print(
                "Error: Pandoc not installed. Install with: brew install pandoc (Mac) or apt-get install pandoc (Linux)"
            )
            return False
...
Examples:
  ...
  %(prog)s data.json -o dist/  # Generate with custom output directory
    ...
    parser.add_argument("data_file", nargs="?", help="YAML or JSON file with syllabus data")
    parser.add_argument(
        "-o", "--output", default="output", help="Output directory (default: output)"
    )
    parser.add_argument(
        "--init", action="store_true", help="Initialize with sample files and templates"
    )
    parser.add_argument(
        "--template-dir", default="templates", help="Template directory (default: templates)"
    )
    ...
    try:
        generator.generate_all_formats(args.data_file, args.output)
